          ...
          @new_resource.sql_sys_roles.each do |sql_sys_role, role_action|
            ...
            when 'ADD'
              if server_version < '11.00.0000.00'
                ...
                alter_statement = "ALTER SERVER ROLE #{sql_sys_role} ADD MEMBER [#{@new_resource.username}]"
              end
            ...
            when 'DROP'
              if server_version < '11.00.0000.00'
                ...
                alter_statement = "ALTER SERVER ROLE #{sql_sys_role} DROP MEMBER [#{@new_resource.username}]"
              end
